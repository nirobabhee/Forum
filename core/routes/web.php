...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Sub-Category
        Route::get('subcategory', 'SubCategoryController@index')->name('sub.category');
        Route::post('subcategory/store', 'SubCategoryController@Store')->name('sub.category.store');
        Route::post('subcategory/update/{id}', 'SubCategoryController@update')->name('sub.category.update');
        //Point-Manages
        Route::get('point/manage', 'PointController@index')->name('point');
        Route::post('point/update', 'PointController@update')->name('point.update');
        //Point-Manages
        Route::get('referral/manage', 'ReferralController@index')->name('referral');
        Route::post('referral/update', 'ReferralController@update')->name('referral.update');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('profile-view', 'UserController@profileView')->name('profile.view');
            ...
            //Post
            Route::get('thread-create', 'PostController@create')->name('post.create');
            Route::post('thread-create', 'PostController@store')->name('post.create');
            Route::get('thread-edit/{id}', 'PostController@edit')->name('post.edit');
            Route::post('thread/update/{id}', 'PostController@update')->name('post.update');
            Route::post('thread/status/change', 'PostController@switchStatus')->name('post.status.change');
            //Post-comment
            Route::post('comments', 'PostController@comment')->name('post.comments');
            ...
            //Purchases-Point//
            Route::get('purchase-point', 'UserController@purchasePoint')->name('purchase.point.form');
            Route::post('store-purchase-point', 'UserController@storePurchasePoint')->name('store.purchase.point');
            //Sales-Point//
            Route::get('convert/point', 'UserController@convertPoint')->name('convert.point');
            Route::post('store/convert/point', 'UserController@storeConvertPoint')->name('store.convert.point');
            ...
            Route::get('vote', 'UserController@submitVote')->name('vote');
            //Balance-transaction//
            Route::get('/transactions/{id}', 'UserController@transactions')->name('transactions');
        });
    });
});


Route::get('post-details/{id}', 'SiteController@postDetails')->name('post.details');
Route::get('user-profile/{id}', 'SiteController@user')->name('post.user.profile');
Route::get('user-posts/{id}', 'SiteController@userPosts')->name('user.posts');
Route::get('user-posts-answered/{id}', 'SiteController@userAnswered')->name('user.answered');
Route::get('posts-up-vote/{id}', 'SiteController@userUpVote')->name('user.upVote');
Route::get('posts-down-vote/{id}', 'SiteController@userDownVote')->name('user.downVote');
Route::get('/forum', 'SiteController@forum')->name('forum');
Route::get('/question', 'SiteController@question')->name('question');
Route::get('/contact', 'SiteController@contact')->name('contact');
Route::post('/contact', 'SiteController@contactSubmit');
Route::get('/change/{lang?}', 'SiteController@changeLanguage')->name('lang');
Route::get('/cookie/accept', 'SiteController@cookieAccept')->name('cookie.accept');
Route::get('blog/{id}/{slug}', 'SiteController@blogDetails')->name('blog.details');
Route::get('policy/{id}/{slug}', 'SiteController@policyPage')->name('policy.page');
//Search
Route::get('/search', 'SiteController@search')->name('search');
Route::get('placeholder-image/{size}', 'SiteController@placeholderImage')->name('placeholder.image');
Route::get('forum-posts/{id}', 'SiteController@postsForum')->name('forum.posts');
Route::get('all-category-posts', 'SiteController@allCategoryPosts')->name('all.category.posts');
Route::get('category-posts/{id}', 'SiteController@postsCategory')->name('category.posts');
