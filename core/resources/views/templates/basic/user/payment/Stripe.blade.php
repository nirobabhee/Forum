                ...
                <div class="card card-deposit">
                    ...
                    <div class="card-body card-body-deposit">
                        ...
                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="form--control"><i class="las la-font"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="form--control input-group-text"><i class="las la-credit-card"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br>
                            <button class="btn btn--gradient btn-block btn-block text-center" type="submit"> @lang('PAY NOW')
                            </button>
                        </form>
