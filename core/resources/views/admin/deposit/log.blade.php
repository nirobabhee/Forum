                                    ...
                                    <tr>
                                        <td data-label="@lang('Gateway | Trx')">
                                            {{-- <span class="font-weight-bold"> <a
                                                    href="{{ route('admin.deposit.method', [$deposit->gateway->alias, 'all']) }}">{{ __($deposit->gateway->name) }}</a>
                                            </span> --}}
                                            @php
                                                try {
                                                    echo $deposit->gateway->alias . ' ' . $deposit->id;
                                                } catch (\Exception $th) {
                                                    echo 'Error' . ' ' . $deposit->id;
                                                }
                                            @endphp
                                            {{-- @dump($deposit->gateway) --}}
                                            <br>
