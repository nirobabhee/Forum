                            ...
                            <tbody>
                                @forelse($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Subscribed At')">
                                            {{ showDateTime($subscriber->created_at) }}</td>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.subscriber.sendEmail') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i
            class="fa fa-fw fa-paper-plane"></i>@lang('Send Email')</a>
@endpush
