...
class GeneralSettingController extends Controller
{
    ...
    {
// validation check krte hobe//
        $request->validate([
            'base_color' => 'nullable', 'regex:/^[a-f0-9]{6}$/i',
            'secondary_color' => 'nullable', 'regex:/^[a-f0-9]{6}$/i',
            'post_point' => 'required|integer|gt:0',
            'comment_point' => 'required|integer|gt:0',
            'register_point' => 'required|integer|gt:0',
            'purchase_price' => 'required|numeric|gt:0',
            'limit_convert_point' => 'required|integer|gt:0',
            'convert_price' => 'required|numeric|gt:0',
            'referral_point' => 'required|numeric|gt:0',
        ]);
        ...
        $general->post_point = $request->post_point;
        $general->comment_point = $request->comment_point;
        $general->register_point = $request->register_point;
        $general->purchase_price = $request->purchase_price;
        $general->limit_convert_point = $request->limit_convert_point;
        $general->convert_price = $request->convert_price;
        $general->referral_point = $request->referral_point;
